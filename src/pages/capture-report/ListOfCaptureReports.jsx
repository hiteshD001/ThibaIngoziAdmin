...
const ListOfCaptureReports = () => {
    ...
    const [archived, setArchived] = useState(getQueryParams.get('isArcheived') ? true : false)
                ...
                <Grid container justifyContent="space-between" alignItems="center" mb={2}>
                    ...
                    <Grid size={{ xs: 12, lg: 9 }} sx={{ display: 'flex', justifyContent: 'flex-end', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: { xs: 2, lg: 0 } }}>
                        ...
                        <Box display="flex" sx={{ justifyContent: { xs: 'space-between' } }} gap={1}>
                            ...
                            <Button
                                onClick={() => nav(`/home/capture-reports?location_id=${getQueryParams.get("location_id")}&isArcheived=true`)}
                                variant="contained"
                                            ...
                                            <TableRow key={report._id}>
                                                ...
                                                <TableCell sx={{ color: '#4B5563' }}>
                                                    <Chip
                                                        ...
                                                        sx={{
                                                            backgroundColor:
                                                                report.report_status === 'No Report' ? '#DCFCE7' :
                                                                    report.report_status === 'View Report' ? '#FEF9C3' :
                                                                        report.report_status == 'View Report' ? '#DBEAFE' :
                                                                            report.report_status == 'pending' ? '#F3F4F6' :
                                                                                '#FEF9C3',
                                                            '& .MuiChip-label': {
                                                                textTransform: 'capitalize',
                                                                color: report.report_status === 'No Report' ? 'green' :
                                                                    report.report_status === 'View Report' ? '#854D0E' :
                                                                        report.report_status == 'View Report' ? '#1E40AF' :
