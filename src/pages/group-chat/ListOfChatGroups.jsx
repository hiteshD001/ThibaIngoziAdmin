...
import { useGetChatGroups, usePutIsArchived } from "../../API Calls/API";
...
const ListOfChatGroups = () => {
    ...
    const UserList = useGetChatGroups("chat group list", role, currentPage, rowsPerPage, filter,locationFilter, startDate, endDate, sortBy, sortOrder);
