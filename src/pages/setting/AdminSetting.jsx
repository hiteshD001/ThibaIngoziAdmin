...
import {
    Box, Typography, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip, IconButton, Chip, Dialog, DialogTitle, DialogContent, DialogActions, Button,
} from "@mui/material";
...
const AdminSetting = () => {
    ...
    console.log("sideData", sideData?.data?.data);
    ...
    const handleEdit = (roleId) => {
        ...
        // Scroll to top after setting editRoleId to ensure form is in edit mode
    ...
    return (
        <Box p={2}>
            <Grid container spacing={2} >
                ...
                <CreateRole editRoleId={editRoleId} setEditRoleId={setEditRoleId} />
                </Grid>
                {/* ---------------- User Assignment ---------------- */}
                <UserAssignment />
            </Grid >
