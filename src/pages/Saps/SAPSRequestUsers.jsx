...
import { useGetSAPSWantedRequestUsers } from "../../API Calls/API";
...
const SAPSWantedRequestUsers = () => {
    ...
    const isReachedUsers = locationPath.state?.isAccepted;
    const locationData = useGetSAPSWantedRequestUsers(locationId, page, rowsPerPage,isReachedUsers,debouncedFilter);
...
export default SAPSWantedRequestUsers;