...
import { useGetFaceScanUsers } from "../../API Calls/API";
...
const FaceScanUsers = () => {
    ...
    const isReachedUsers = locationPath.state?.type;
    const locationData = useGetFaceScanUsers(locationId, page, rowsPerPage,isReachedUsers,debouncedFilter);
            ...
            <Paper elevation={1} sx={{ backgroundColor: "rgb(253, 253, 253)", mb: 2, padding: 2, borderRadius: '10px' }}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" mb={2}>
                    <Grid size={{ xs: 12, lg: 3 }} sx={{ display: 'flex', flexDirection: 'row', gap: 2, mb: { xs: 1, md: 0 } }}>
                        <Typography variant="h6" fontWeight={590}> Face Scan Users</Typography>
                    </Grid>
