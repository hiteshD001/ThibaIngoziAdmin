...
import { useGetCrimeReportRequestUsers } from "../../API Calls/API";
...
const CrimeReportRequestUsers = () => {
    ...
    const locationData = useGetCrimeReportRequestUsers(locationId, page, rowsPerPage,isReachedUsers,debouncedFilter);
...
export default CrimeReportRequestUsers;