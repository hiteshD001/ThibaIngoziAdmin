...
import {
    Box, Typography, TextField, Button, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Grid, InputAdornment, Stack, Select, MenuItem,
} from "@mui/material";
...
const FlaggedReport = () => {
    ...
    const reportList = [
        {
            _id: 1,
            messageContent: "Suspicious activity near Main Road...I saw someone checking car doors in the parking lot. Wearing dark clothes and a cap.",
            AnonymosCode: 'User#4532',
            RealName: "John Smith",
            time: "Today, 09:45 PM",
            group: 'Cape Town - Sea Point'
        },
        {
            _id: 2,
            messageContent: "Suspicious activity near Main Road...I saw someone checking car doors in the parking lot. Wearing dark clothes and a cap.",
                    ...
                    <Grid size={{ xs: 12, lg: 9 }} sx={{ display: 'flex', justifyContent: 'flex-end', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: { xs: 2, lg: 0 } }}>
                        ...
                        <Box display="flex" sx={{ justifyContent: { xs: 'space-between' } }} gap={1}>
                            ...
                            <Button
                                ...
                                onClick={() => nav("/home/flagged-reports")}
                        ...
                        <TableContainer >
                            <Table sx={{ '& .MuiTableCell-root': { fontSize: '15px' } }}>
                                <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                                    <TableRow >
                                        <TableCell sx={{ backgroundColor: '#F9FAFB', color: '#4B5563', borderTopLeftRadius: '10px' }}>Message Content</TableCell>
                                        <TableCell sx={{ backgroundColor: '#F9FAFB', color: '#4B5563' }}>Anonymous Code</TableCell>
                                        <TableCell sx={{ backgroundColor: '#F9FAFB', color: '#4B5563' }}>Real Name Admin View.</TableCell>
                                        <TableCell sx={{ backgroundColor: '#F9FAFB', color: '#4B5563' }}>TimeStamp</TableCell>
                                        <TableCell sx={{ backgroundColor: '#F9FAFB', color: '#4B5563' }}>Group Name</TableCell>
                                        ...
                                        <TableRow key={user._id}>
                                            ...
                                            <TableCell >
                                                <Box align="center" sx={{ display: 'flex', flexDirection: 'row' }}>
                                                    <IconButton onClick={() => nav(`/home/flagged-report`)}>
                                                        <img src={flaggedBtn} alt="flagged button" />
                                                    </IconButton>
